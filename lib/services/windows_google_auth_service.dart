...
class WindowsGoogleAuthService {
  ...
  Future<Map<String, dynamic>> completeSignIn(String authorizationCode) async {
    try {
      ...
      await _secureStorage.write(key: 'google_access_token', value: accessToken);
      if (refreshToken != null) {
        await _secureStorage.write(key: 'google_refresh_token', value: refreshToken);
      }
  ...
  Future<bool> isSignedIn() async {
    final accessToken = await _secureStorage.read(key: 'google_access_token');
  ...
  Future<void> signOut() async {
    ...
    await _secureStorage.delete(key: 'google_refresh_token');
  }
}
